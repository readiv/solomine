...
def parser():
    try:
        ...
        EU=  private_api.get_hashpower_fixedprice("EU", "OCTOPUS", 0.001)
        EU_N =  private_api.get_hashpower_fixedprice("EU_N", "OCTOPUS", 0.001)
        USA =  private_api.get_hashpower_fixedprice("USA", "OCTOPUS", 0.001)
        USA_E =  private_api.get_hashpower_fixedprice("USA_E", "OCTOPUS", 0.001)

        diff_uno = diff(difficulty = difficulty,
                        max_price = max_price,
                        EU_001 = EU["fixedPrice"],
                        EU_005 = private_api.get_hashpower_fixedprice("EU", "OCTOPUS", 0.010)["fixedPrice"],
                        ...
                        EU_N_005 = private_api.get_hashpower_fixedprice("EU_N", "OCTOPUS", 0.010)["fixedPrice"],
                        ...
                        USA_005 = private_api.get_hashpower_fixedprice("USA", "OCTOPUS", 0.010)["fixedPrice"],
                        ...
                        USA_E_005 =  private_api.get_hashpower_fixedprice("USA_E", "OCTOPUS", 0.010)["fixedPrice"],
